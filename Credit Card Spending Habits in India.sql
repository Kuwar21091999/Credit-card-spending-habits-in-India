--Dataset imporeted from www.kaggle.com
...
--4- write a query to find city which had lowest percentage spend for gold card typeselect city,card_type,sum(amount) as amount from credit_card_transcations
with cte as (
